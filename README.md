...
INTRO calculates by sliding the entire genome as a given window range, and presents statistic value as well as Z-score value derived from bootstrap and jacknife approaches.
